...
name as input. Thefunction should perfore a linear search to find the target product in the list and
return a list of indices of all occurrences of the product if found, or an empty list if the product is not 
found.
"""


def linearSearchProduct(productlist, targeProduct):
 indices = []
 ...
 target = "shoes"
 target2 = 'apple'
 result = linearsearcProduct(products, target2)
 print(result)
