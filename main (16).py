...
cannot be acccessed directly from outside the class. write a program to create an instance of the
...
class BankAccount:
 ...
 def  deposit(self, amount):
   if amount > 0:
      ...
      # self.__account_balancself.__account_balance+amount
